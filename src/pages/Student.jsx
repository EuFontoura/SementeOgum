...
export default function Student() {
  ...
  async function finishExam() {
    if (!user || !selectedProva || Object.keys(answers).length === 0)
      return alert("Responda pelo menos uma questão para concluir.");
    ...
    await setDoc(resultRef, {
      ...
      provaName: selectedProva.name,
      provaDay: selectedProva.day,
      answers,
      score,
