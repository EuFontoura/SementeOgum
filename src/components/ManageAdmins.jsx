...
export function ManageAdmins() {
  ...
  return (
    <div className="my-8 p-4 border rounded-lg shadow border-purple-300">
      <h2 className="text-xl font-bold mb-4 text-purple-700">Gerenciar Administradores</h2>
      ...
      {message && <p className="mb-3 text-sm font-semibold text-green-700">{message}</p>}
